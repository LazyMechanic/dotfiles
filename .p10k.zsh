# Generated by Powerlevel10k configuration wizard on 2020-01-01 at 19:30 MSK.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 27287.
# Wizard options: nerdfont-complete + powerline, small icons, rainbow,
# angled separators, sharp heads, sharp tails, 2 lines, solid, left frame, darkest,
...
() {
  ...
  typeset -g POWERLEVEL9K_STATUS_OK_BACKGROUND=6
  ...
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE_BACKGROUND=6
